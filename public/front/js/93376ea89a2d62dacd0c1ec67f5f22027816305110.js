...
jQuery(document).ready(function() {
    ...
    function resize_gallery() {
        jQuery('.item .picframe').each(function() {
            ...
            jQuery(this).find("img").css("height", "auto !important");
            jQuery(this).find("img").on('load', function() {
                var w = jQuery(this).css("width");
                var h = jQuery(this).css("height");
                if (!jQuery(this).parent().parent().parent().parent().hasClass('grid')) {
                    jQuery(this).parent().css("height", "239px");
                }
                var obj = jQuery(this).parent().parent().find(".overlay-1");
                obj.css("width", w);
                obj.css("height", "239px");
            }).each(function() {
    ...
    jQuery(window).load(function() {
        ...
        jQuery('#filters a').on("click", function() {
            ...
            if (jQuery(this).attr('data-filter') === '*') {
                $container.addClass('showyourself');
            } else {
                $container.removeClass('showyourself');
            }
        ...
        var revapi;
        var $aks = window.devicePixelRatio;
        var fullscreenonoff = "off";
        if ($aks == 1) {
            fullscreenonoff = "on";
        }
        revapi = jQuery('#revolution-slider').revolution({
            ...
            hideThumbs: 10,
            fullWidth: "on",
            fullScreen: fullscreenonoff,
            fullScreenOffsetContainer: "",
            touchenabled: "on",
            responsiveLevels: [2048, 1024, 778, 480],
            gridheight: [650, 500, 450, 350],
            navigationType: "none",
            dottedOverlay: ""
        });
