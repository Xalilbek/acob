            ...
            <div class="content-body">
                <form id="project_form" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <h4 class="form-section"><i class="icon-mail6"></i>
                        {{ $id > 0 ? "Proyektə düzəliş et" : "Yeni proyekt yarat"}}
                    </h4>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <input class="btn btn-success" type="button" value="Əlavə et"
                                   onclick="addRow('#dataTable')"/>
                        </div>
                        <table class="table" id="dataTable" width="350px">
                            <tr>
                                <th>Sil</th>
                                <th>Adı</th>
                                <th>Dəğəri</th>
                            ...
                            @if (!is_null($project))
                                @foreach($project->projectDescriptions as $key => $desc)
                                    <tr>
                                        <td><input class="btn btn-danger" type="button" value="Sil"
                                                   onclick="deleteRow(this)"/>
                                        </td>
                                        <td><input class="form-control border-primary" type="text"
                                                   name="description[{{ $key }}][name]" value="{{ $desc['name'] }}"/>
                                        </td>
                                        <td><input class="form-control border-primary" type="text"
                                                   name="description[{{ $key }}][value]" value="{{ $desc['value'] }}"/>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
                    ...
                    {{--                            <div id="errors" style="color: tomato;"></div>--}}
...
@section('js')
    <script>
        ...
        function addRow(element) {
            ...
            let table = $(element),
                currentRow = table.find('tr').length - 1;

            table.append(' <tr>\n' +
                '                                <td><input class="btn btn-danger" type="button" value="Sil" onclick="deleteRow(this)"/></td>\n' +
                '                                <td><input class="form-control border-primary" type="text" name="description[' + currentRow + '][name]"/></td>\n' +
                '                                <td><input class="form-control border-primary" type="text" name="description[' + currentRow + '][value]"/></td>\n' +
                '                            </tr>');
        }
