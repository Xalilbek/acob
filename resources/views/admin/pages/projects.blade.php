    ...
    <div class="app-content content container-fluid">
        <div class="content-wrapper">
            <div class="content-header row">
                <a href="{{ route('admin.project',0) }}" type="submit" class="btn btn-primary" style="float: right;margin-bottom: 20px;">
                    <i class="icon-plus"></i> Yeni project
                </a>
                    ...
                    <table class="table">
                        ...
                        @foreach($projects as $key => $project)
                            <tr id="{{ $project['id'] }}">
                                ...
                                <td><a href="{{ route('admin.project',$project['id']) }}">
                                        <i class="icon-pencil"></i>
                                    </a>
                                </td>
                                <td><a href="{{ route('admin.project.delete',$project['id']) }}">
...
@section('js')
    <script>
        ...
        $('#sirala').on('click',function(){
            ...
            $.post('/admin/project/order',{ids , _token: '{{ csrf_token() }}'})
            .then(()=>{
                $('#load').hide();
            })
        })
