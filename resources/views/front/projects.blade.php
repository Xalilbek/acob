...
@section('content')
    <section id="subheader" data-speed="8" data-type="background"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>{{ __('setting.menu.projects') }}</h1>
                    <ul class="crumb">
                        <li><a href="/">{{ __('setting.menu.home') }}</a></li>
                        <li class="sep">/</li>
                        <li>{{ __('setting.menu.projects') }}</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="portfolio" class="no-top no-bottom">
        <div class="container">
            ...
            <div style="width:100%;" class="siralama">
                <div class="select">
                    ...
                    <ul class="select-options">
                        ...
                        <li rel="1"><a
                                href="{{ route('front.projects',['area_order' => 'desc']) }}">{{ __('setting.area_desc') }}</a>
                        </li>
                        <li rel="2"><a
                                href="{{ route('front.projects',['area_order' => 'asc']) }}">{{ __('setting.area_asc') }}</a>
                        </li>
                        <li rel="3"><a
                                href="{{ route('front.projects',['price_order' => 'desc']) }}">{{ __('setting.price_desc') }}</a>
                        </li>
                        <li rel="4"><a
                                href="{{ route('front.projects',['price_order' => 'asc']) }}">{{ __('setting.price_asc') }}</a>
                        </li>
                    </ul>
            ...
            <div id="gallery"
                 ...
                 data-wow-delay=".3s"
                 style="margin-top: 50px; visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp; position: relative; height: 1334px; opacity: 0;">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 item mb30 residential"
                        ...
                        <div class="picframe" style="height: 239px;">
                            ...
                            <img class="img-responsive" src="{{ url("/assets/images/projects/".$project['image']) }}"
                                 alt="acob.az ev tikinti layihesi , {{ $project['title'] }}"
